    ...
    <aside class="app-navbar">
        ...
        <div class="sidebar-nav scrollbar scroll_light">
            <ul class="metismenu " id="sidebarNav">
                ...
                <li>
                    <a  href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-settings"></i><span class="nav-title">Account Settings</span> </a>
                </li>
                <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-wallet"></i><span class="nav-title">Transactions</span></a>
                    <ul aria-expanded="false">
                        <li> <a href='calendar-full.html'>Depost to wallet</a> </li>
                        <li> <a href='calendar-list.html'>Withdraw from wallet</a> </li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-bag"></i> <span class="nav-title">Crypto Investments</span></a>
                    <ul aria-expanded="false">
                        <li> <a href="ui-alerts.html">Matured Investments</a> </li>
                        <li> <a href="ui-accordions.html">Running Investments</a> </li>

                    </ul>
                </li>
                <li>
                    <a  href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-user"></i><span class="nav-title">Downlines</span> </a>
                </li>
                <li><a href="app-chat.html" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Chat with Us</span></a> </li>
                <li class="sidebar-banner p-4 bg-gradient text-center m-3 d-block rounded">
                    <h5 class="text-white mb-1">Mentor Crypto
                    </h5>
                    <p class="font-13 text-white line-20">International And Casual </p>
                    <a class="btn btn-square btn-inverse-light btn-xs d-inline-block mt-2 mb-0" href="#">Logout</a>
                </li>
            </ul>
        </div>
        <!-- end sidebar-nav -->
